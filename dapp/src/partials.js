angular.module('multiSigWeb').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('src/partials/wallet.html',
    ...
    "	<h1>{{wallet.name}} {{balance|ether}}</h1>\n" +
    ...
    "				ng-click=\"removeOwnerOffline()\"\n" +
    "				class=\"btn btn-default\"\n" +
    "				show-hide-by-connectivity=\"offline\"\n" +
    "			>\n" +
    "				Remove offline\n" +
    "			</button>\n" +
    "			<button\n" +
    ...
    "	<div class=\"panel-heading\">\n" +
    "		<div class=\"pull-right\">\n" +
    "			<button type=\"button\" ng-click=\"addToken()\" class=\"btn btn-default\">Add</button>\n" +
    "			<button type=\"button\" ng-click=\"hideTokens=true\" class=\"btn btn-default\" ng-hide=\"hideTokens\">\n" +
    "				<span class=\"glyphicon glyphicon-menu-up\" aria-hidden=\"true\"></span>\n" +
    "			</button>\n" +
    "			<button\n" +
    "				type=\"button\"\n" +
    "				ng-click=\"hideTokens=false\"\n" +
    "				class=\"btn btn-default\"\n" +
    "				ng-show=\"hideTokens\"\n" +
    "			>\n" +
    "				<span class=\"glyphicon glyphicon-menu-down\" aria-hidden=\"true\"></span>\n" +
    ...
    "					{{token.name}}\n" +
    "					<div class=\"pull-right\">\n" +
    "						<button type=\"button\" class=\"btn btn-default btn-sm\" ng-click=\"editToken(token)\">\n" +
    "							Edit\n" +
    "						</button>\n" +
    "						<button type=\"button\" class=\"btn btn-danger btn-sm\" ng-click=\"removeToken(token)\">\n" +
    "							Remove\n" +
    "						</button>\n" +
    "					</div>\n" +
    "				</td>\n" +
    ...
    "					</div>\n" +
    "				</td>\n" +
    "				<td>{{userTokens[token.address]|token}}</td>\n" +
    "			</tr>\n" +
    "		</tbody>\n" +
    "	</table>\n" +
    ...
    "				class=\"btn btn-default\"\n" +
    "				disabled-if-no-accounts\n" +
    "				ng-click=\"confirmMultisigTransactionOffline()\"\n" +
    "				show-hide-by-connectivity=\"offline\"\n" +
    "			>\n" +
    "				Confirm offline\n" +
    "			</button>\n" +
    ...
    "				class=\"btn btn-default\"\n" +
    "				disabled-if-no-accounts\n" +
    "				ng-click=\"revokeMultisigTransactionOffline()\"\n" +
    "				show-hide-by-connectivity=\"offline\"\n" +
    "			>\n" +
    "				Revoke offline\n" +
    "			</button>\n" +
    ...
    "				class=\"btn btn-default\"\n" +
    "				disabled-if-no-accounts\n" +
    "				ng-click=\"executeMultisigTransactionOffline()\"\n" +
    "				show-hide-by-connectivity=\"offline\"\n" +
    "			>\n" +
    "				Execute offline\n" +
    "			</button>\n" +
    ...
    "				<td>{{txId|bigNumber}}</td>\n" +
    "				<td>\n" +
    "					<div\n" +
    "						uib-popover=\"{{transactions[txId].to}}\"\n" +
    "						popover-enable=\"'true'\"\n" +
    ...
    "					</div>\n" +
    "				</td>\n" +
    "				<td>{{transactions[txId].value|ether}}</td>\n" +
    "				<td>\n" +
    "					<div class=\"text-center\" ng-show=\"!transactions[txId].dataDecoded.title\">-</div>\n" +
    "					<div class=\"row\">\n" +
    "						<div\n" +
    "							ng-class=\"{'col-md-8': transactions[txId].dataDecoded.notDecoded || transactions[txId].dataDecoded.params, 'col-md-12': !transactions[txId].dataDecoded.notDecoded && !transactions[txId].dataDecoded.params}\"\n" +
    "						>\n" +
    "							<span\n" +
    "								popover-trigger=\"'mouseenter'\"\n" +
    "								uib-popover-template=\"'partials/multisigData.html'\"\n" +
    "								popover-placement=\"bottom\"\n" +
    "								popover-append-to-body=\"true\"\n" +
    "								popover-enable=\"transactions[txId].data != '0x'\"\n" +
    "							>\n" +
    ...
    "									{{param.name}}:\n" +
    "									<span\n" +
    "										uib-popover-template=\"'partials/addressPopoverTemplate.html'\"\n" +
    "										popover-enable=\"param.value && param.value.toString().length > 7\"\n" +
    ...
    "						</div>\n" +
    "						<div\n" +
    "							ng-class=\"{'col-md-4': transactions[txId].dataDecoded.notDecoded || transactions[txId].dataDecoded.params}\"\n" +
    "							ng-show=\"transactions[txId].dataDecoded.notDecoded || transactions[txId].dataDecoded.params\"\n" +
    "						>\n" +
    "							<button\n" +
    "								class=\"btn btn-default btn-sm pull-right\"\n" +
    "								ng-click=\"editABI(transactions[txId].to)\"\n" +
    "							>\n" +
    "								Edit ABI\n" +
    "							</button>\n" +
    "						</div>\n" +
    ...
    "					<div class=\"row\">\n" +
    "						<div\n" +
    "							ng-class=\"{'col-md-12' : transactions[txId].executed, 'col-md-6' : !transactions[txId].executed}\"\n" +
    "						>\n" +
    "							<ul ng-repeat=\"owner in transactions[txId].confirmations\">\n" +
    "								<li>{{wallet.owners[owner].name}}</li>\n" +
    "							</ul>\n" +
    "						</div>\n" +
    "						<div\n" +
    "							ng-hide=\"transactions[txId].executed || transactions[txId].confirmed\"\n" +
    "							ng-class=\"{'col-md-12' : !transactions[txId].confirmations.length, 'col-md-6' : transactions[txId].confirmations.length}\"\n" +
    "						>\n" +
    "							<button\n" +
    "								type=\"button\"\n" +
    "								class=\"btn btn-default btn-sm pull-right\"\n" +
    ...
    "							ng-class=\"{'col-md-12' : transactions[txId].executed, 'col-md-6' : !transactions[txId].executed}\"\n" +
    "						>\n" +
    "							<span ng-show=\"transactions[txId].executed\"> Yes </span>\n" +
    "							<span ng-hide=\"transactions[txId].executed\"> No </span>\n" +
    "						</div>\n" +
    "						<div\n" +
    "							class=\"col-md-6\"\n" +
    ...
    "							<button\n" +
    "								type=\"button\"\n" +
    "								class=\"pull-right btn btn-default btn-sm pull-right\"\n" +
    "								ng-show=\"!transactions[txId].executed && transactions[txId].confirmations.length == confirmations\"\n" +
    ...
    "		No multisig transactions. Send a multisig transaction\n" +
    "		<a href=\"\" ng-click=\"addTransaction()\">now</a>.\n" +
    "	</div>\n" +
    "	<div class=\"panel-footer\">\n" +
    "		<ul\n" +
    "			uib-pagination\n" +
  ...
  $templateCache.put('src/partials/modals/configureGas.html',
    "<div class=\"modal-header\">\n" +
    "	<h3 class=\"modal-title\">Configure Gas</h3>\n" +
    "</div>\n" +
    "<form class=\"form\" name=\"form\">\n" +
    "	<div class=\"modal-body\">\n" +
    "		<div class=\"form-group\">\n" +
  ...
  $templateCache.put('src/partials/modals/safeMigration.html',
    "<div class=\"modal-header\">\n" +
    "	<h3 class=\"modal-title\">Gnosis Safe Multisig is like Multisig but better!!</h3>\n" +
    "</div>\n" +
    "<div class=\"modal-body\" id=\"modal-body\">\n" +
    "	<p>\n" +
    "		Gnosis Safe Multisig is a successor to the Multisig Wallet. Migrate your old Multisig and enjoy\n" +
    "		new benefits:\n" +
    "	</p>\n" +
    "\n" +
    ...
    "			<li>\n" +
    "				<h4>Future Proof</h4>\n" +
    "				The upgradable and modular design allows you to be ready for future use-cases and\n" +
    "				asset-types\n" +
    "			</li>\n" +
    "			<li>\n" +
    "				<h4>Formally Verified</h4>\n" +
    "				While our code is always audited, we've gone one step further and formally verified the\n" +
    ...
    "				You will soon be able to interact with various protocols right from the Safe Multisig\n" +
    "				interface\n" +
    "			</li>\n" +
    "			<li>\n" +
    ...
    "		</li>\n" +
    "		<li>Try out the new interface and learn about the many benefits.</li>\n" +
    "		<li>\n" +
    "			As soon as you feel comfortable, start moving funds to your new Safe.\n" +
    "			<a href=\"https://safe.gnosis.io/multisig\" target=\"_blank\">read more</a>\n" +
    "		</li>\n" +
    "	</ul>\n" +
    "	<div class=\"form-group centered-dash\">\n" +
    "		<button class=\"safe-migration-btn\" ng-click=\"create()\">Create new Safe</button>\n" +
    "	</div>\n" +
    "	<div class=\"form-group\">Questions? <a href=\"mailto:safe@gnosis.io\">Get in touch!</a></div>\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "	<input type=\"checkbox\" ng-model=\"data.hideMigrationModal\" ng-checked=\"data.hideMigrationModal\" />\n" +
    "	Don't show this again\n" +
    "	<button class=\"btn btn-danger\" type=\"button\" ng-click=\"dismiss()\">Dismiss</button>\n" +
    "</div>\n"
  );
  ...
  $templateCache.put('src/partials/modals/sendTransaction.html',
    "<div class=\"modal-header\">\n" +
    "	<h3 class=\"modal-title\">Send transaction</h3>\n" +
    "</div>\n" +
    "<form name=\"form\" class=\"form\">\n" +
    "	<div class=\"modal-body\">\n" +
    "		<div class=\"form-group\">\n" +
    ...
    "				class=\"form-control\"\n" +
    "				ng-model=\"abi\"\n" +
    "				ng-change=\"updateMethods()\"\n" +
    "				ng-required=\"!tx.value\"\n" +
    "			></textarea>\n" +
    "		</div>\n" +
    "		<div class=\"form-group\">\n" +
    ...
    "					<input\n" +
    "						ng-attr-id=\"{{ 'value-' + $index }}\"\n" +
    "						ng-switch-default\n" +
    "						type=\"text\"\n" +
    "						class=\"form-control\"\n" +
    "						ng-model=\"params[$index]\"\n" +
    "					/>\n" +
    "				</div>\n" +
    "			</div>\n" +
    "		</div>\n" +
  ...
  $templateCache.put('src/partials/modals/walletTransaction.html',
    "<div class=\"modal-header\">\n" +
    "	<h3 class=\"modal-title\">Send multisig transaction</h3>\n" +
    "</div>\n" +
    "<form class=\"form\" name=\"form\">\n" +
    "	<div class=\"modal-body\">\n" +
    "		<div class=\"form-group\">\n" +
    ...
    "				<a\n" +
    "					target=\"_blank\"\n" +
    "					href=\"https://gist.githubusercontent.com/AndreiD/3025ffb034268eb3a6e5e9939860cad2/raw/dd5df923ede526d474efcc9257fea0531fe2aa70/stablecoin_abi\"\n" +
    "					>StableCoins ABI</a\n" +
    "				>\n" +
    "			</label>\n" +
    "\n" +
  ...
  $templateCache.put('src/partials/modals/web3Wallets.html',
    "<div class=\"modal-header\">\n" +
    "	<div class=\"bootstrap-dialog-header\">\n" +
    "		<div class=\"bootstrap-dialog-title\">No account found</div>\n" +
    "	</div>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "	<p>\n" +
    ...
    "	</p>\n" +
    "	<p>\n" +
    "		You can monitor existing wallets without an account management software but you cannot create\n" +
    "		new wallets or sign transactions!\n" +
    "	</p>\n" +
    ...
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "	<button type=\"button\" ng-click=\"ok()\" class=\"btn btn-default\" id=\"terms-button\">Ok</button>\n" +
    "</div>\n"
  );
